...
try:
    ...
    if e.args[0] == 'AIRFLOW_HOME':
        path = 'D:/33 module/airflow_hw-main'
...
def predict():
    ...
    def load_model() -> Pipeline:
        models_path = os.path.join(path, 'dags', 'models')
    ...
    def load_tests_data():
        tests_path = os.path.join(path, 'test')
    ...
    result.to_csv(os.path.join(path, 'dags', 'predictions', csv_filename))
